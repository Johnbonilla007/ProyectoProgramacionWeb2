        ...
        <div class="right_col" role="main">
          ...
          <div class="clearfix"></div>
              ...
              <div class="title_center">
                <h3 class="text-center">Listado De Ciudades</h3>
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                          ...
                          ?>
                        <tr>
                          <td class="text-center"><?php echo $ciudad['Id']?></td>
                          <td class="text-center"><?php echo $ciudad['Nombre']?></td>
                          <td class="text-center"><?php echo $ciudad['DeptoID']?></td>
