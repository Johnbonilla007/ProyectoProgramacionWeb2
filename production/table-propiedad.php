             ...
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-building-o"></i>Propiedades<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     <li><a href="table_city.php">Publicar</a></li>
                      <li><a href="table_city.php">Propiedades en Venta</a></li>
                      <li><a href="table-depto.php">Departamentos</a></li>
                      <li><a href="table-ciudad.php">Ciudades</a></li>
                      <li><a href="form_wizards.html">Pais</a></li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="clearfix"></div>
              ...
              <div class="title_center">
                <h3 class="text-center">Propiedades en venta </h3>
